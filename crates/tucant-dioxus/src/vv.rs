                                ...
                                .map(|entry| {
                                    rsx! {
                                        li { class: "list-group-item",
                                                ...
                                                h5 { class: "mb-1",
                                                    Link {
                                                        to: Route::CourseDetails {
                                                            course: entry.coursedetails_url.clone(),
                                                        },
                                            ...
                                            div { class: "d-flex w-100 justify-content-between",
                                                h6 { class: "mb-1", {entry.lecturer_name.clone().unwrap_or_default().to_string()} }
                                            }
                                            h6 { class: "mb-1", {entry.date_range.clone().unwrap_or_default().to_string()} }
                                        }
                                    }
                                })
                        }
