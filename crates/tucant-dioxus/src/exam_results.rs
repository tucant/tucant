...
pub fn ExamResults(semester: ReadOnlySignal<SemesterId>) -> Element {
    let handler = async |tucan: RcTucanType, current_session, revalidation_strategy, additional| tucan.exam_results(&current_session, revalidation_strategy, additional).await;
