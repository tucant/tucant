...
pub fn ExamResults() -> impl IntoView {
    ...
    let handler = async |tucan: Arc<ApiServerTucan>, current_session, revalidation_strategy, additional: Signal<SemesterId>| tucan.exam_results(&current_session, revalidation_strategy, additional.get()).await;
