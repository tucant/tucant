        ...
        view! {
            <div class="container">
                <h2 class="text-center">
                    {"Registration "} <button type="button" class="btn btn-light">
                ...
                <ul class="list-group">
                    {data
                        ...
                        .map(|entry| {
                            view! {
                                <a
                                    href=format!("/registration/{}", entry.1.clone())
                                                ...
                                                view! {
                                                    <li class="list-group-item">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            <h5 class="mb-1">
                                                                <a href=format!(
                                                                    "/course-details/{}",
                                                                    course.1.url.clone(),
                                                                )>{format!("Kurs {} {}", course.1.id, course.1.name)}</a>
                                                            </h5>
                                                            {move || {
                                                                if let Some(registration_until) = &course
                                                                    .1
                                                                    .registration_until
                                                                {
                                                                    view! {
                                                        ...
                                                        <h6 class="mb-1">
                                                            {format!(
                                                                "{}",
                                                                course.1.begin_and_end.clone().unwrap_or_default(),
                                                            )}
                                                        </h6>
