        ...
        view! {
            <div class="container">
                <h2 class="text-center">
                    {data.title} <button type="button" class="btn btn-light">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <div class="d-flex w-100 justify-content-between">
                                        <h6 class="mb-1">
                                            {format!(
                                                "{}",
                                                entry.lecturer_name.clone().unwrap_or_default(),
                                            )}
                                        </h6>
                                    </div>
                                    <h6 class="mb-1">
                                        {format!(
                                            "{}",
                                            entry.date_range.clone().unwrap_or_default(),
                                        )}
                                    </h6>
                                </li>
                            }
