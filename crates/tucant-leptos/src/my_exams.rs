...
pub fn MyExams() -> impl IntoView {
    ...
    let handler = async |tucan: Arc<ApiServerTucan>, current_session, revalidation_strategy, additional: Signal<SemesterId>| tucan.my_exams(&current_session, revalidation_strategy, additional.get()).await;
