            ...
            data
                ...
                .map(|(name, url)| {
                    view! {
                        <li>
                            <a
                                href=format!("/vv/{}", url.clone())
                                class="dropdown-item bg-success-subtle"
                                class:disabled=data.get().is_none()
                            >
                                {name.clone()}
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li>
                    <a
                        class="dropdown-item"
                        class:disabled=move || data.get().is_none()
                        href=move || {
                            data
                                .get()
                                .transpose()
                    ...
                    <a
                        href=move || {
                            data
                                ...
                                .flatten()
                                .map(|d| {
                                    format!("/vv/{}", d.logged_in_head.vorlesungsverzeichnis_url)
                                })
                        }
                        class="dropdown-item bg-success-subtle"
                        class:disabled=move || data.get().transpose().ok().flatten().is_none()
                    >
