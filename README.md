...
~/.cargo/bin/dx serve --platform web --features api --verbose
...
~/.cargo/bin/dx serve --wasm --bundle web --base-path assets # --hot-patch this lets everything explode with "env" imports and sqlite import stuff broken
