...
export async function course(
  input: string,
): Promise<WithTucanUrlW0NvbXBsZXRlQ291cnNlLCBDb3Vyc2VHcm91cFtdLCBDb3Vyc2VFdmVudFtdLCBNYXliZUNvbXBsZXRlTW9kdWxlW10sIHN0cmluZ10> {
  return (await genericFetch(
    "http://localhost:8080/course",
    input,
  )) as WithTucanUrlW0NvbXBsZXRlQ291cnNlLCBDb3Vyc2VHcm91cFtdLCBDb3Vyc2VFdmVudFtdLCBNYXliZUNvbXBsZXRlTW9kdWxlW10sIHN0cmluZ10;
}
export async function course_group(
  input: string,
): Promise<WithTucanUrlW0NvbXBsZXRlQ291cnNlLCBDb3Vyc2VHcm91cCwgQ291cnNlR3JvdXBFdmVudFtdLCBzdHJpbmdd> {
  return (await genericFetch(
    "http://localhost:8080/course-group",
    input,
  )) as WithTucanUrlW0NvbXBsZXRlQ291cnNlLCBDb3Vyc2VHcm91cCwgQ291cnNlR3JvdXBFdmVudFtdLCBzdHJpbmdd;
}
export async function courses(
  input: string | null,
): Promise<WithTucanUrlW1ZWTWVudUl0ZW0sIFZWTWVudUl0ZW1bXSwgTWF5YmVDb21wbGV0ZUNvdXJzZVtdLCBWVk1lbnVQYXRoUGFydFtdW11d> {
  return (await genericFetch(
    "http://localhost:8080/courses",
    input,
  )) as WithTucanUrlW1ZWTWVudUl0ZW0sIFZWTWVudUl0ZW1bXSwgTWF5YmVDb21wbGV0ZUNvdXJzZVtdLCBWVk1lbnVQYXRoUGFydFtdW11d;
}
export async function exam(
  input: string,
): Promise<WithTucanUrlW0V4YW0sIE1heWJlQ29tcGxldGVNb2R1bGVbXSwgTWF5YmVDb21wbGV0ZUNvdXJzZVtdXQ> {
  return (await genericFetch(
    "http://localhost:8080/exam",
    input,
  )) as WithTucanUrlW0V4YW0sIE1heWJlQ29tcGxldGVNb2R1bGVbXSwgTWF5YmVDb21wbGV0ZUNvdXJzZVtdXQ;
}
...
export async function my_courses(
  input: null,
): Promise<WithTucanUrlW01heWJlQ29tcGxldGVDb3Vyc2VbXSwgQ291cnNlR3JvdXBbXV0> {
  return (await genericFetch(
    "http://localhost:8080/my-courses",
    input,
  )) as WithTucanUrlW01heWJlQ29tcGxldGVDb3Vyc2VbXSwgQ291cnNlR3JvdXBbXV0;
}
export async function my_exams(
  input: null,
): Promise<WithTucanUrlW1tNYXliZUNvbXBsZXRlTW9kdWxlLCBFeGFtXVtdLCBbTWF5YmVDb21wbGV0ZUNvdXJzZSwgRXhhbV1bXV0> {
  return (await genericFetch(
    "http://localhost:8080/my-exams",
    input,
  )) as WithTucanUrlW1tNYXliZUNvbXBsZXRlTW9kdWxlLCBFeGFtXVtdLCBbTWF5YmVDb21wbGV0ZUNvdXJzZSwgRXhhbV1bXV0;
}
export async function my_modules(
  input: null,
): Promise<WithTucanUrlTWF5YmVDb21wbGV0ZU1vZHVsZVtd> {
  return (await genericFetch(
    "http://localhost:8080/my-modules",
    input,
  )) as WithTucanUrlTWF5YmVDb21wbGV0ZU1vZHVsZVtd;
}
...
export async function search_module(input: string): Promise<SearchResult[]> {
  return (await genericFetch(
    "http://localhost:8080/search-modules",
    input,
  )) as SearchResult[];
}
export async function search_module_opensearch(
  ...
  return (await genericFetch(
    "http://localhost:8080/search-modules-opensearch",
    input,
  )) as SearchResult[];
}
