...
export async function my_courses(input: null): Promise<WithTucanUrlQ291cnNlW10> {
        return await genericFetch("http://localhost:8080/my_courses", input) as WithTucanUrlQ291cnNlW10
}
export async function my_modules(input: null): Promise<WithTucanUrlTW9kdWxlW10> {
        return await genericFetch("http://localhost:8080/my_modules", input) as WithTucanUrlTW9kdWxlW10
}
...
export async function search_module_opensearch(input: string): Promise<SearchResult[]> {
        return await genericFetch("http://localhost:8080/search-module-opensearch", input) as SearchResult[]
}
export type Course =
{
  tucan_id: string,
