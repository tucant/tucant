...
export async function course(input: string): Promise<WithTucanUrlW01heWJlQ29tcGxldGVDb3Vyc2UsIENvdXJzZUdyb3VwW10sIENvdXJzZUV2ZW50W10sIE1vZHVsZVtdLCBzdHJpbmdd> {
        return await genericFetch("http://localhost:8080/course", input) as WithTucanUrlW01heWJlQ29tcGxldGVDb3Vyc2UsIENvdXJzZUdyb3VwW10sIENvdXJzZUV2ZW50W10sIE1vZHVsZVtdLCBzdHJpbmdd
}
export async function course_group(input: string): Promise<WithTucanUrlW01heWJlQ29tcGxldGVDb3Vyc2UsIENvdXJzZUdyb3VwLCBDb3Vyc2VHcm91cEV2ZW50W10sIHN0cmluZ10> {
        return await genericFetch("http://localhost:8080/course-group", input) as WithTucanUrlW01heWJlQ29tcGxldGVDb3Vyc2UsIENvdXJzZUdyb3VwLCBDb3Vyc2VHcm91cEV2ZW50W10sIHN0cmluZ10
}
...
export type CourseOrCourseGroup =
 | { type: "Course", value: [MaybeCompleteCourse, CourseGroup[], CourseEvent[], Module[]] }
...
export type WithTucanUrlW01heWJlQ29tcGxldGVDb3Vyc2UsIENvdXJzZUdyb3VwLCBDb3Vyc2VHcm91cEV2ZW50W10sIHN0cmluZ10 =
{
  tucan_url: string,
  inner: [MaybeCompleteCourse, CourseGroup, CourseGroupEvent[], string],
}
export type WithTucanUrlW01heWJlQ29tcGxldGVDb3Vyc2UsIENvdXJzZUdyb3VwW10sIENvdXJzZUV2ZW50W10sIE1vZHVsZVtdLCBzdHJpbmdd =
{
  tucan_url: string,
  inner: [MaybeCompleteCourse, CourseGroup[], CourseEvent[], Module[], string],
}
