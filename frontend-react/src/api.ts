...
export async function course(
  input: string,
): Promise<WithTucanUrlW0NvdXJzZSwgQ291cnNlR3JvdXBbXSwgQ291cnNlRXZlbnRbXSwgTW9kdWxlW10sIHN0cmluZ10> {
  return (await genericFetch(
    "http://localhost:8080/course",
    input,
  )) as WithTucanUrlW0NvdXJzZSwgQ291cnNlR3JvdXBbXSwgQ291cnNlRXZlbnRbXSwgTW9kdWxlW10sIHN0cmluZ10;
}
export async function course_group(
  input: string,
): Promise<WithTucanUrlW0NvdXJzZSwgQ291cnNlR3JvdXAsIENvdXJzZUdyb3VwRXZlbnRbXSwgc3RyaW5nXQ> {
  return (await genericFetch(
    "http://localhost:8080/course-group",
    input,
  )) as WithTucanUrlW0NvdXJzZSwgQ291cnNlR3JvdXAsIENvdXJzZUdyb3VwRXZlbnRbXSwgc3RyaW5nXQ;
}
export async function courses(
  input: string | null,
): Promise<WithTucanUrlW1ZWTWVudUl0ZW0sIFZWTWVudUl0ZW1bXSwgQ291cnNlW10sIFZWTWVudVBhdGhQYXJ0W11bXV0> {
  return (await genericFetch(
    "http://localhost:8080/courses",
    input,
  )) as WithTucanUrlW1ZWTWVudUl0ZW0sIFZWTWVudUl0ZW1bXSwgQ291cnNlW10sIFZWTWVudVBhdGhQYXJ0W11bXV0;
}
export async function exam(
  input: string,
): Promise<WithTucanUrlW0V4YW0sIE1vZHVsZVtdLCBDb3Vyc2VbXV0> {
  return (await genericFetch(
    "http://localhost:8080/exam",
    input,
  )) as WithTucanUrlW0V4YW0sIE1vZHVsZVtdLCBDb3Vyc2VbXV0;
}
...
export async function my_exams(
  input: null,
): Promise<WithTucanUrlW1tNb2R1bGUsIEV4YW1dW10sIFtDb3Vyc2UsIEV4YW1dW11d> {
  return (await genericFetch(
    "http://localhost:8080/my-exams",
    input,
  )) as WithTucanUrlW1tNb2R1bGUsIEV4YW1dW10sIFtDb3Vyc2UsIEV4YW1dW11d;
}
...
export type WithTucanUrlW0NvdXJzZSwgQ291cnNlR3JvdXBbXSwgQ291cnNlRXZlbnRbXSwgTW9kdWxlW10sIHN0cmluZ10 =
  {
    tucan_url: string;
    inner: [Course, CourseGroup[], CourseEvent[], Module[], string];
  };
