...
pub async fn welcome(client: &MyClient) -> Result<(), TucanError> {
    ...
    <p style="line-height: 140%;"> <strong>"Aktuelles: Fristen zur Prüfungsanmeldung in TUCaN für das Wintersemester 2024/2025"

    </strong> </p>


    <p style="line-height: 140%;">"Die Anmeldezeit zu Prüfungen im WiSe 2024/2025 hat in der Regel am 15. November 2024 begonnen."<br></br>" In vielen Studiengängen endet die Anmeldefrist am 15. Dezember 2024 - bitte informieren Sie sich rechtzeitig! Ihre Anmeldung nehmen Sie im TUCaN-Webportal im Bereich "<i>"Prüfungen"</i>" unter "<i>"Meine Prüfungen / Anmeldung zu Prüfungen"</i>" vor."</p>

    <p style="line-height: 140%;">"Fachbereiche können darüber hinaus individuelle Fristen festlegen. Die An- und Abmeldefristen entnehmen Sie bitte den "<a href="http://www.tu-darmstadt.de/tucan-pruefungsdetails" target="_blank">"Prüfungsdetails"</a>" in TUCaN."</p>




    "→" <a href="https://www.tu-darmstadt.de/studieren/studierende_tu/studienorganisation_und_tucan/hilfe_und_faq/index.de.jsp" target="_blank">"Hilfe &amp; FAQ zur Prüfungsanmeldung"</a><br></br>
